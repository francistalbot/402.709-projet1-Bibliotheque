...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('livres', function (Blueprint $table) {
            ...
            $table->string('publication_annee')->after('isbn')->nullable(false);
            $table->unsignedBigInteger('categorie_id')->after('publication_annee')->nullable(false);
    ...
    public function down(): void
    {
        Schema::table('livres', function (Blueprint $table) {
            ...
            $table->dropColumn(['titre', 'auteur_id', 'isbn', 'publication_annee', 'categorie_id', 'resume', 'prix']);
        });
    }
};
